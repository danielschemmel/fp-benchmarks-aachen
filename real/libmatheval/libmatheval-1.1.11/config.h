...
/* Define to 1 if you have the `scm_c_define_gsubr' function. */
/* #undef HAVE_SCM_C_DEFINE_GSUBR */

/* Define to 1 if you have the `scm_make_gsubr' function. */
/* #undef HAVE_SCM_MAKE_GSUBR */

/* Define to 1 if you have the `scm_num2dbl' function. */
...
#define PACKAGE_STRING "libmatheval 1.1.11"
